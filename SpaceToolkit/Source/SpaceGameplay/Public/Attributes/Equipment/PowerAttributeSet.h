...
UCLASS()
class SPACEGAMEPLAY_API UPowerAttributeSet : public UAttributeSetBase
{
	GENERATED_BODY()
public :
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, ShieldPower);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, ShieldPower);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, ShieldDistribution);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, ShieldDistribution);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, EnginePower);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, EnginePower);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, EngineDistribution);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, EngineDistribution);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, BatteryPower);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, BatteryPower);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, BatteryDistribution);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, BatteryDistribution);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, LifeSupportPower);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, LifeSupportPower);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, LifeSupportDistribution);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, LifeSupportDistribution);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, SensorPower);
	ATTRIBUTE_TAG_ACCESSOR(UPowerAttributeSet, SensorPower);
	ATTRIBUTE_ACCESSORS(UPowerAttributeSet, SensorDistribution);
