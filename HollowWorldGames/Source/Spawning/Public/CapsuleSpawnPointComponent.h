...
#include "CapsuleSpawnPointComponent.generated.h"


UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class SPAWNING_API UCapsuleSpawnPointComponent : public UCapsuleComponent, public ISpawnPoint
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UCapsuleSpawnPointComponent();
